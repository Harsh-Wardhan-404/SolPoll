-- CreateEnum
CREATE TYPE "PollType" AS ENUM ('BINARY', 'MULTIPLE_CHOICE', 'CUSTOM');
...
-- AddForeignKey
ALTER TABLE "Report" ADD CONSTRAINT "Report_pollId_fkey" FOREIGN KEY ("pollId") REFERENCES "Poll"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
